...
void setup() {
  ...
  servoMinUpToMid (servo13);
  servoMinUpToMid (servo14);
  servoMinUpToMid (servo15);
  delay(10);
...
void loop() {
  ...
  servoMinUpToMax(servo14);

   
  
  servoMinUpToMax(servo1);
  servoMinUpToMax(servo15);
  
   

  servoMaxDownToMid(servo0);
  servoMaxDownToMid(servo14);

   

  servoMidDownToMin(servo1);
  servoMidDownToMin(servo15);

   

  servoMinUpToMax(servo2);
  servoMinUpToMax(servo12);


  servoMinUpToMax(servo3);
  servoMinUpToMax(servo13);
  
   

  servoMaxDownToMid(servo2);
  servoMaxDownToMid(servo12);
   

  servoMidDownToMin(servo3);
  servoMidDownToMin(servo13);
